...
class TranslationComparator(RelationshipProperty.Comparator):
    """
    RelationshipProperty.Comparator modification to enable the use of like, startswith, endswith and contains directly
    on the relationship. Each of the comparators compares against the first non-null item in the list of columns
    (languages) available, in order of preference (see ordered_languages() in this module).
